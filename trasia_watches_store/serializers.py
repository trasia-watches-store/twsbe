...
class WatchSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Watch
        fields = ('pk', 'productCode' ,'name', 'type', 'features', 'price', 'stockNum', 'brand', 'family', 'model', 'limited', 'water_resistance_depth', 'case_description', 'dial_description', 'movement_description', 'wimage', 'created_at', 'updated_at')
